  ...
  return (
    <Router key={Math.random()} history={hashHistory}>
      ...
      <Route path="/" component={ProgressBar} data={data}>
        ...
        <Route path="step4/:mode/1/:id" component={FamilyMemberDetails} onChange={onFamilyMemberChange} onDelete={onFamilyMemberDelete} data={data.FamilyMember} isEdited={isEdited}/>
        <Route path="step4/:mode/2/:id" component={FamilyMemberClinicalInfo} onChange={onFamilyMemberChange} onDelete={onFamilyMemberDelete} data={data.FamilyMember} clinicalInfoData={data.ClinicalInfo} isEdited={isEdited}/>

 ...
 */
export function getPricing(panelId, payer, familyExtras) {
  return fetch(`${process.env.REACT_APP_BASE_URL}/pricing?panelId=${panelId}&payer=${payer}&familyExtras=${familyExtras}`)

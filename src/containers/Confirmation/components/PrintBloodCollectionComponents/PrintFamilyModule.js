...
export default function PrintFamilyModule(props) {
  return (
    <Section>
      <PrintHeading>
        {props.familyMemberDetails.relationship} <span>of</span> {props.patientDetails.firstName + ' ' + props.patientDetails.lastName} - {props.familyMemberDetails.firstName + ' ' + props.familyMemberDetails.lastName}
      </PrintHeading>
